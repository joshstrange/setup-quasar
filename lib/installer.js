...
exports.installNpmPkg = exports.logInstalledInfo = exports.installPods = exports.installJava = exports.installQuasar = exports.installCordova = void 0;
 ...
 */
function installQuasar(version) {
    return __awaiter(this, void 0, void 0, function* () {
        yield installNpmPkg('@quasar/cli', version);
    });
}
exports.installQuasar = installQuasar;
/**
 * Install Java
 *
 */
 ...
 *
 */
function logInstalledInfo(command = 'quasar info') {
    return __awaiter(this, void 0, void 0, function* () {
        core.info('Cordova/Quasar environment has been setup successfully.');
